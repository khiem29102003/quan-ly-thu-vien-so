<?php $__env->startSection('title', 'Đăng Ký - Quản Lý Thư Viện'); ?>
    ...
    <div class="card" style="width: 100%; max-width: 480px;">
        ...
        <form action="/register" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="tel" name="phone" class="form-control" placeholder="0123456789" value="<?php echo e(old('phone')); ?>" required>
            </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLTV\resources\views/auth/register.blade.php ENDPATH**/ ?>