<?php $__env->startSection('title', 'Cấu Hình Thanh Toán & Hệ Thống'); ?>
    ...
    <form action="<?php echo e(url('/admin/settings')); ?>" method="POST">
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 2rem; margin-bottom: 2rem;">
            ...
            <div style="flex: 1; min-width: 300px;">
                <div style="display: grid; grid-template-columns: 1fr; gap: 1.25rem;">
                    <div>
                        ...
                        <input type="text" id="bank_bin" name="bank_bin" class="form-control" value="<?php echo e($bankConfig['bank_bin'] ?? ''); ?>" required placeholder="VD: 970436 (Vietcombank)" onkeyup="previewQR()">
                    ...
                    <div>
                        ...
                        <input type="text" id="account_no" name="account_no" class="form-control" value="<?php echo e($bankConfig['account_no'] ?? ''); ?>" required placeholder="Nhập đúng số" onkeyup="previewQR()">
                    </div>
                    <div>
                        <label style="display:block; margin-bottom:0.5rem; font-weight:600; color: #475569;">Tên Chủ Tài Khoản</label>
                        <input type="text" id="account_name" name="account_name" class="form-control" value="<?php echo e($bankConfig['account_name'] ?? ''); ?>" required placeholder="VIẾT HOA KHÔNG DẤU" onkeyup="previewQR()">
                    </div>
                </div>
            </div>
            ...
            <div style="width: 250px; display: flex; flex-direction: column; justify-content: center; align-items: center; background: #f8fafc; border: 2px dashed #cbd5e1; border-radius: 12px; padding: 1.5rem;">
                ...
                <div style="background: white; padding: 0.5rem; border-radius: 8px; box-shadow: var(--shadow-sm);">
                    <img id="qr-preview" src="https://img.vietqr.io/image/<?php echo e($bankConfig['bank_bin'] ?? '970436'); ?>-<?php echo e($bankConfig['account_no'] ?? '0987654321'); ?>-compact2.png?amount=50000&addInfo=NAP%201&accountName=<?php echo e(urlencode($bankConfig['account_name'] ?? 'THU VIEN')); ?>" style="width: 100%; height: auto; transition: all 0.3s;" alt="Preview QR">
                </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.25rem; margin-bottom: 2rem;">
            <div>
                ...
                <input type="text" name="momo_phone" class="form-control" value="<?php echo e($momoConfig['phone'] ?? ''); ?>" required placeholder="Nhập SDT MoMo">
            </div>
            <div>
                <label style="display:block; margin-bottom:0.5rem; font-weight:600; color: #475569;">Tên Chủ MoMo</label>
                <input type="text" name="momo_name" class="form-control" value="<?php echo e($momoConfig['name'] ?? ''); ?>" required placeholder="Nguyễn Văn A">
            </div>
        </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLTV\resources\views/admin/settings.blade.php ENDPATH**/ ?>