<?php $__env->startSection('title', 'Chỉnh Sửa Thông Tin - Tài Khoản'); ?>
    ...
    <div class="chart-container">
        ...
        <form action="/member/profile" method="POST">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" id="name" name="name" value="<?php echo e(old('name', Auth::user()->name)); ?>" class="form-control" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem;" required>
                <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    <p style="margin: 0.25rem 0 0 0; color: #dc2626; font-size: 0.85rem;"><?php echo e($message); ?></p>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="email" id="email" name="email" value="<?php echo e(Auth::user()->email); ?>" class="form-control" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem; background: #f3f4f6; cursor: not-allowed;" disabled readonly>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="tel" id="phone" name="phone" value="<?php echo e(old('phone', Auth::user()->phone)); ?>" class="form-control" placeholder="0912345678" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem;">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <textarea id="address" name="address" rows="3" class="form-control" placeholder="Số nhà, đường phố, quận huyện, tỉnh/thành phố" style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem; font-family: sans-serif;"><?php echo e(old('address', Auth::user()->address ?? '')); ?></textarea>
    ...
    <div class="chart-container">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem;">
            ...
            <div style="padding: 1rem; background: linear-gradient(135deg, rgba(6, 182, 212, 0.05) 0%, rgba(8, 145, 178, 0.03) 100%); border-radius: 8px; border-left: 3px solid #06b6d4;">
                ...
                <p style="margin: 0.5rem 0 0 0; font-size: 1.1rem; color: #1f2937; font-weight: 600;">
                    <?php if(Auth::user()->role === 'member'): ?>
                        👤 Thành Viên
                    <?php elseif(Auth::user()->role === 'librarian'): ?>
                        📚 Thủ Thư
                    <?php else: ?>
                        👨‍💼 Quản Trị Viên
                    <?php endif; ?>
            ...
            <div style="padding: 1rem; background: linear-gradient(135deg, rgba(14, 165, 233, 0.05) 0%, rgba(2, 132, 199, 0.03) 100%); border-radius: 8px; border-left: 3px solid #0ea5e9;">
                ...
                <p style="margin: 0.5rem 0 0 0; font-size: 1.1rem; color: #1f2937; font-weight: 600;"><?php echo e(Auth::user()->created_at->format('d/m/Y')); ?></p>
            </div>
            ...
            <div style="padding: 1rem; background: linear-gradient(135deg, rgba(245, 158, 11, 0.05) 0%, rgba(217, 119, 6, 0.03) 100%); border-radius: 8px; border-left: 3px solid #f59e0b;">
                ...
                <p style="margin: 0.5rem 0 0 0; font-size: 1.1rem; color: #1f2937; font-weight: 600;">#<?php echo e(Auth::user()->id); ?></p>
            </div>
        </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\QLTV\resources\views/member/edit-profile.blade.php ENDPATH**/ ?>