...
<head>
    ...
    <?php endif; ?>
    <title><?php echo $__env->yieldContent('title', 'Quản Lý Thư Viện'); ?></title>
...
<body>
            ...
            <ul class="nav-links">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php else: ?>
                        ...
                        <li>
                            <a href="<?php echo e(route('borrows.reservations')); ?>">
                                <i class="fas fa-inbox"></i><span>Duyệt Mượn</span>
                                <?php if(($adminNavBadges['pending_reservations'] ?? 0) > 0): ?>
                                    <span class="nav-badge"><?php echo e($adminNavBadges['pending_reservations']); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="/wallet-topups">
                                ...
                                <?php if(($adminNavBadges['pending_topups'] ?? 0) > 0): ?>
                                    <span class="nav-badge"><?php echo e($adminNavBadges['pending_topups']); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                        <li>
                            <a href="/activity-logs">
                                ...
                                <?php if(($adminNavBadges['pending_total'] ?? 0) > 0): ?>
                                    <span class="nav-badge"><?php echo e($adminNavBadges['pending_total']); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
    ...
    <script>
        ...
        (function () {
            let latestReservationId = <?php echo e((int) ($adminNavBadges['latest_pending_reservation_id'] ?? 0)); ?>;
            const toastWrap = document.getElementById('realtimeToastWrap');
            const endpoint = '<?php echo e(route('admin.realtime-notifications')); ?>';
            let audioCtx = null;
...
<?php /**PATH D:\QLTV\resources\views/layout.blade.php ENDPATH**/ ?>